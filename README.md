...
Despite that situation the electricity cost is around 57p / day average, based on 770 days running up to the end of 2025.
...
The recent data is used to calculate the running average.
